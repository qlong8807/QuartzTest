...
public class InterruptExample {
  ...
  public void run() throws Exception {
    ...
    JobDetail job = newJob(DumbInterruptableJob.class).withIdentity("interruptableJob7", "group7").build();

    SimpleTrigger trigger = newTrigger().withIdentity("trigger7", "group7").startAt(startTime)
